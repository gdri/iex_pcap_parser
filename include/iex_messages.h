...
public:
    ...
    /// \brief Message fields values to std::list.
    virtual std::list<std::string> ToList() const = 0;

    /// \brief Message type std::list of field names.
    virtual std::list<std::string> Header() const = 0;
...
struct IEXTPHeader : public IEXMessageBase {
    ...
    /// \brief Message fields values to std::list.
    virtual std::list<std::string> ToList() const override;

    /// \brief Message type std::list of field names.
    virtual std::list<std::string> Header() const override;
